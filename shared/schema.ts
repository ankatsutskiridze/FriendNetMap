...
export const users = pgTable("users", {
  ...
  email: text("email").unique(), // Added for Firebase mapping
  firebaseUid: text("firebase_uid").unique(), // Added for Firebase mapping
  password: text("password"), // Made optional for Firebase users
...
export const insertFriendRequestSchema = createInsertSchema(introRequests)
  .omit({
    id: true,
    createdAt: true,
    status: true,
